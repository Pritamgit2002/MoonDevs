...
const { openChainModal, walletChain } = useWallet();
const { allSupplies, suppliesChain } = useAppSupplies(true);
const statsSupplies = supplies;
const tokenAddress = fetchAddressForChain(
  suppliesChain?.id,
  isOldToken ? "oldToken" : "newToken"
);
const BurnStatsContainerContent = () => {
  return (
    <BurnStatsContainer>
...
export default BurnStatsContainerContent;
